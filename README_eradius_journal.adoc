...
Mon Feb 02 10:15:25 2015 10.38.0.1:24208 [195] Accounting-Request
    ...
    Framed-Protocol = GPRS-PDP-Context
    NAS-Port-Type = Wireless-Other
    X_3GPP-IMSI = "234159150687262"
    Acct-Session-Id = "D4B790E7047BB263"
    Acct-Authentic = RADIUS
    Acct-Multi-Session-Id = "D4B790E7047BB263"
    Framed-MTU = 1500
    Event-Timestamp = 2015-02-02T10:15:25
    Framed-IP-Address = 10.38.11.151
    NAS-Port = 67931
----
...
[listing]
----
cat radius.log | grep 234159150687262
----
